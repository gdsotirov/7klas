...
-- -----------------------------------------------------
-- Placeholder table for view `7klas`.`SchoolDistrictsJSON`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `7klas`.`SchoolDistrictsJSON` (`json_obj` INT);
...
-- -----------------------------------------------------
-- View `7klas`.`SchoolDistrictsJSON`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `7klas`.`SchoolDistrictsJSON`;
USE `7klas`;
